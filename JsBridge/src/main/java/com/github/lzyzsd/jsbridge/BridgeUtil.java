...
public class BridgeUtil {
	final static String UTLIFE_OVERRIDE_SCHEMA = "utlife://";
	final static String YY_RETURN_DATA = UTLIFE_OVERRIDE_SCHEMA + "return/";//格式为   utlife://return/{function}/returncontent
