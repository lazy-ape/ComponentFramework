package com.utlife.core.baseadapter;
...
public class ListViewHolder
{
    ...
    public ListViewHolder setSize(int viewId,int width,int height){
        ViewGroup.LayoutParams params = getView(viewId).getLayoutParams();
        if(params != null){
            params.width = width;
